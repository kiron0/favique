      ...
      <CardContent>
        ...
        >
          {preview ? (
            ...
            <div className="py-8">
              <p className="text-gray-500 mb-2">Drag & drop an image here or</p>
          ...
          <label
            htmlFor="file-upload"
            className="cursor-pointer inline-block px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-md text-sm font-medium mt-2"
          >
            Select File
          </label>
        </div>
